        ...
        <article className="wrap mx-auto max-w-prose2">
          ...
          <div className="mt-9 space-y-7 text-[0.95rem] leading-relaxed text-ink/75">
            <section>
              ...
              <p className="mt-3">
                When you apply for a readiness audit we collect the details
                you enter in the application form — your school name, your name
                and role, contact details and your preferred appointment time. We also record standard
            ...
            <section>
              ...
              <p className="mt-3">
                Our form, email and analytics providers process this data on
                our behalf under their own terms. Applications are collected
                through Tally, which receives the answers you submit. There is
                no payment step and we never collect payment details.
              </p>
            </section>
