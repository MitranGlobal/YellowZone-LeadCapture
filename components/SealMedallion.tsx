 ...
 *
 * Deliberately built on three.js and R3F core only — no drei. The one helper
 * we needed, a texture loader, is a single line of three.js, and skipping drei
 * keeps `three-mesh-bvh` and its deprecation warning out of the dependency
 * tree entirely.
 */
